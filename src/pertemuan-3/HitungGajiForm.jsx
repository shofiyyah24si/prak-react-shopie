  ...
  return (
    <div className="flex flex-col items-center justify-center m-5 p-5 bg-gray-100">
      <div className="bg-white p-6 rounded-lg shadow-lg w-96">
        ...
        <div className="mb-4">
          <label className="block text-gray-700 font-medium mb-1">
            Pajak: <b className="text-purple-500">11%</b>
          </label>
        </div>

        {/* Conditional Rendering */}
        {!gaji || gaji <= 0 ? (
          <div className="mt-4 p-3 bg-purple-200 border-l-4 border-purple-500 text-purple-700">
          ...
          <div className="mt-4 p-3 bg-blue-100 border-l-4 border-blue-500 text-blue-700">
            <p className="font-semibold"> Total Take Home Pay (THP): Rp{" "} {Number(totalGaji).toLocaleString("id-ID")} </p>
          </div>
        )}
      </div>
    </div>
